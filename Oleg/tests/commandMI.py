commandOleg_valid = (
    ...
    "Курс - (валюта)",
    "Сердце - (кол-во - цвет)",
    "Яндекс - (запрос в поисковике яндекса)",
    "Отправь сообщение - (Подпись человека в вк - текст смс)",
    "Стоп\Олег стоп",
    "Последние сообщение",
    "Ответь на сообщение - (текс смс)",
    "Запусти - (название приложения)",
    "Включи\выключи - (название устройства умного дома)",
    "Таймер - (время в минутах\секундах\часах), Рассчитай наливной\стяжку - (следуйте инструкции)",
)
