    ...
    messages = [
        {
            ...
            "content": (
                ...
                "Ответ не должен превышать 950 символов."
                "делай отступы от ЧИСЛА с обоих сторон пример - не правильно: 'в 1941-1945.', правильно: 'в 1941 - 1945 .'"
                "не правильно: 'ему 25, он', правильно: 'ему 25 , он', всегда должны быть пробелы в начале и конце ЧИСЛА."
                "не правильно: '90-е', правильно: '90 -e'. Остальной текст без изменений"
            ),
        }
    ]
